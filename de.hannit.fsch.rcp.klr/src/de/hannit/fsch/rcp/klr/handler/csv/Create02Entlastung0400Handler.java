 ...
 *
 */
public class Create02Entlastung0400Handler extends CSVHandler
{
 ...
 * gebildet.
 */
private static final String DATEINAME_PRÄFIX = "02_CSV_Entlastung 0400 auf KTR_";
private static final String DATEINAME_SUFFIX = ".csv";
	...
	feld8 = ZELLE8;
		...
		System.out.println(feld1+feld2+feld3+feld4+feld5+feld6+feld7+feld8);
		}
	...
	boolean ready = false;
		...
		if (mSummen.isChecked() && mSummen.isSummeOK() && getMonatsnummer(mSummen.getBerichtsMonatAsDate()).equalsIgnoreCase("01"))
		{
		ready = true;
		}
	return ready;
