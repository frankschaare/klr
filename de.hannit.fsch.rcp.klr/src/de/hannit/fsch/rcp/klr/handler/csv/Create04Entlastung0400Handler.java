 ...
 *
 */
public class Create04Entlastung0400Handler extends CSVHandler
{
 ...
 * gebildet.
 */
private static final String DATEINAME_PRÄFIX = "04_CSV_Entlastung 0400 auf KTR_";
private static final String DATEINAME_SUFFIX = ".csv";
	...
	boolean ready = false;
		...
		if (mSummen.isChecked() && mSummen.isSummeOK() && getMonatsnummer(mSummen.getBerichtsMonatAsDate()).equalsIgnoreCase("03"))
		{
		ready = true;
		}
	return ready;
