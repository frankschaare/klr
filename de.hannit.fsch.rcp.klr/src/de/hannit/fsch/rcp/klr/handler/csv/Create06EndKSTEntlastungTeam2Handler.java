...
public class Create06EndKSTEntlastungTeam2Handler extends CSVHandler
{
...
private static final String ZELLE3 = "1200160";
...
private static final String DATEINAME_PRÄFIX = "06_CSV_EndKST-Entlastung Team 2 ";
private static final String DATEINAME_SUFFIX = ".csv";
	...
	boolean ready = false;
		...
		if (gk.isChecked() && gk.isDatenOK() && gk.getAktuellesTeam().equalsIgnoreCase("2"))
		{
		ready = true;
		}
	return ready;
